...
describe("lang.Object", function() {
  ...
  it("IsEmpty", function() {
    ...
    assert.equal(false, qx.lang.Object.isEmpty({
      a: undefined
    }));
    assert.equal(false, qx.lang.Object.isEmpty({
      a: null
  ...
  it("Contains", function() {
    assert.isTrue(qx.lang.Object.contains({
      a: 1
    }, 1));
  });
  ...
  it("Equals", function() {
    ...
    assert.isFalse(qx.lang.Object.equals({
      1: {
        name: "mhc",
        age: 28
      },
    ...
    assert.isFalse(qx.lang.Object.equals(function(x) {
      return x;
    }, function(y) {
      return y + 2;
    }));
