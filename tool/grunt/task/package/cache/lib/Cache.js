...
q.Class.define("Cache",
{
  ...
  construct: function(basePath)
  {
    ...
    this.__checkfilePath = path.join(basePath, Cache.CHECKFILE);
  ...
  members:
  {
    ...
    createCacheId: function(kind, envMap, cacheId, buildType) {
      ...
      return (!buildType)
             ? kind + '#' + hashedEnvMap + '-' + cacheId
             : kind + '#' + buildType + '#' + hashedEnvMap + '-' + cacheId;
    },
