...
/*eslint semi:0*/
=======
/* eslint semi:0, no-wrap-func:0, no-redeclare:0, no-eval:0, new-cap:0 */
>>>>>>> master
(function() {
        ...
        if (window.navigator) {
          var d = this,
            n = {
              ...
              Num: h.num ? /\d/ : 0
            }, f, c, g, m, l, b, a = navigator.mimeTypes,
            k = navigator.plugins,
            o = null;
          if (h.mimes && a) {
      ...
      init: {
        ...
        detectIE: function () {
          var init = this,
            ...
            browser = $.browser,
            doc = document,
            x, tmp, userAgent = window.navigator ? navigator.userAgent || "" : "",
        ...
        hasMimeType: function (b) {
          var a = function (h) {
            if (h && window.navigator && navigator.mimeTypes) {
              var l, k, d, g, c = navigator.mimeTypes,
