...
qx.Class.define("qx.ui.dialog.BusyIndicator",
{
  ...
  construct : function(label)
  {
    ...
    this.super("construct", label, qx.ui.Image.PLACEHOLDER_IMAGE);
  ...
  members :
  {
     ...
     */
    _onAppear : function() {
      this.__animationHandle = this.getIconWidget().animate(qx.ui.dialog.BusyIndicator.SPINNER_ANIMATION);
    },
    ...
    {
      var iconWidget = this.super("_createIconWidget", iconUrl);
  ...
  classDefined : function() {
    qx.ui.dialog.BusyIndicator.SPINNER_ANIMATION = {
      duration: 750,
      timing: "linear",
