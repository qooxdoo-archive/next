...
describe("bom.Location", function ()
{
  ...
  it("DivWithBodyPadding", function() {
      __bodyStyles.padding = "10px";
  ...
  it("DivWithBodyBorder", function() {
      __bodyStyles.border = "10px solid black";
