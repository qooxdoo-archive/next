...
describe("io.part.ClosurePart", function() {
  ...
  it("load part with two packages", function() {
  ...
  it("load part with two packages and one already loading", function() {
  ...
  it("load part with two packages and both already loading", function() {
    var pkg1 = new qx.test.io.part.MockPackage("p1", null, null, null, true);
    var pkg2 = new qx.test.io.part.MockPackage("p2", null, null, null, true);
  ...
  it("load part with three packages and delay", function() {
  ...
  it("load part with two packages and delay first part", function() {
    if (this.isLocal()) {
  ...
  it("load part with an error package", function() {
  ...
  it("load part with a loaded package should not reload the package again", function() {
  ...
  it("load a part with preloaded package", function() {
